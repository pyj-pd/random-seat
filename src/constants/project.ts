...
export const SITE_DESCRIPTION = `최대 ${MAX_SEAT_COLUMN_SIZE}×${MAX_SEAT_ROW_SIZE} 크기의 랜덤 자리 뽑기! 클릭 한 번으로 공평하게 뽑고, 랜덤으로 배치한 자리는 PDF로 저장하여 손쉽게 인쇄 및 공유할 수 있습니다. 학교, 버스, 행사 등 어디든지 사용해보세요!`
